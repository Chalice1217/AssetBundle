...
public class OneSceneAB  
{
    ...
    public OneSceneAB(string sceneName)
    {
    ...
    public void UnloadAsset(string bundleName, string assetName)
    {
        ...
        else
        {
            ...
            nameCacheDic.Remove(bundleName); //TODO不知道加不加?
            Resources.UnloadUnusedAssets();
        }
           // nameBundleDic[bundleName].UnloadAsset(asset);
    }
    ...
    {
        foreach (var item in nameCacheDic.Keys)
        {
    ...
    {
        foreach (var item in nameBundleDic.Keys)
        {
            Dispose(item);       
        }
        nameBundleDic.Clear();
