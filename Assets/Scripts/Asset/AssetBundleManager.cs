...
public class AssetBundleManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        // 先加载 Manifest 文件
        StartCoroutine(ManifestLoader.Instance.Load());
    }

    /// <summary>
    /// 场景名 和 场景里面所有的包的管理 的映射
    /// </summary>
    private Dictionary<string, SceneManager> nameSceneDic = new Dictionary<string, SceneManager>();
    ...
    private void LoadAssetBundleCallBack(string sceneName,string bundleName)
    {
        ...
        {
            Debug.LogError("不存在该场景:" + sceneName);
        }
    }
